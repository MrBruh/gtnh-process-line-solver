...
#1/#6): place (SA over a routing-aware cost) -> assign auto-output for adjacent machines ->
route pipes for the rest -> assemble -> validate against the independent validator, so it
never returns a silently-invalid layout. When an attempt leaves nets unrouted it penalizes
