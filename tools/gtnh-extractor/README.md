...
scope here:** texture mapping (lane 6). No game logic beyond raw coordinate collection lives in
this tool by design; all interpretation is the Python adapter's.
